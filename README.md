...
planner that schedules around your real day (daily limits, an energy curve and
the meetings already in your calendar), an AI assistant that runs on **your own**
provider keys, a morning digest, calendar export/sync, and TG11 single sign-on
readiness.
...
deploy/         Apache vhosts, systemd units (app + digest timer), deploy script
